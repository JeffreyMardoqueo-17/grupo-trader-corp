...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_28px_rgba(37,211,102,0.45)] transition-transform duration-300 hover:scale-105 will-change-transform"
      style={{ paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom))', paddingRight: 'max(1.5rem, env(safe-area-inset-right))' }}
    >
      <svg
        viewBox="0 0 24 24"
